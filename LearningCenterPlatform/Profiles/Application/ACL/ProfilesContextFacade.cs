...
using LearningCenterPlatform.Profiles.Domain.Model.Queries;
using LearningCenterPlatform.Profiles.Domain.Model.ValueObjects;
using LearningCenterPlatform.Profiles.Domain.Services;
using LearningCenterPlatform.Profiles.Interfaces.ACL;

namespace LearningCenterPlatform.Profiles.Application.ACL;
