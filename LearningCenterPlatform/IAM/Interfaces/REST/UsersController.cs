...
using LearningCenterPlatform.IAM.Domain.Model.Queries;
using LearningCenterPlatform.IAM.Domain.Services;
using LearningCenterPlatform.IAM.Infrastructure.Pipeline.Middleware.Attributes;
using LearningCenterPlatform.IAM.Interfaces.REST.Resources;
using LearningCenterPlatform.IAM.Interfaces.REST.Transform;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Annotations;

namespace LearningCenterPlatform.IAM.Interfaces.REST;
